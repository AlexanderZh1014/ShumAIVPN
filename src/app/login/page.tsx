  ...
  return (
    <main className="min-h-screen bg-[#0e0100] text-[#fffbff]">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        ...
        <a href="/register" className="text-sm text-[#ffd7cd] hover:text-white">
          Create Account
        </a>
      </nav>
      ...
      <section className="relative flex min-h-[80vh] items-center justify-center px-6">
        ...
        <div className="w-full max-w-md rounded-3xl border border-[#ff7a1b]/25 bg-[#1e0800]/90 p-8 shadow-2xl shadow-orange-950/40">
          ...
          <p className="mt-3 text-center text-sm text-[#ffd7cd]">
            Access your ShumAI VPN dashboard.
          </p>
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-4">
            ...
            <button className="w-full rounded-2xl bg-[#ff4002] py-3 font-semibold text-white shadow-lg shadow-orange-950/40 hover:bg-[#ff562a]">
              Login
            </button>
          </form>

          {message && (
            <p className="mt-4 rounded-xl border border-[#ff4002]/30 bg-[#ff4002]/10 p-3 text-sm text-[#ffd7cd]">
              {message}
            </p>
          )}
        </div>
